rule hisat:
    input:
        i1 = f"/home/users/mvladka/projects/jotnarlogs/cilia_snake/data/processed/{{sample}}/{{sample}}_trimmed.fq.gz"
    ...
    params:
        index_file = "/home/users/mvladka/projects/jotnarlogs/intermediate_files/aurli_index"
    log:
        f"/home/users/mvladka/projects/jotnarlogs/cilia_snake/data/logs/{{sample}}_hisat.log"
    threads:
        40
    shell:
        "hisat2 -q -x {params.index_file} -U {input.i1} | samtools sort -o {output} &> {log}" 
